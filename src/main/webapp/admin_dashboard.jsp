...
<body>
    ...
    <main>
        <div >
            <h2>Welcome, Admin!</h2>
            <p>Here you can manage the fundraising system.</p>
        </div>

        <div class="action-containers">
            <div class="dashboard-container">
                <h3>Manage Users</h3>
                <p>View, add, edit, or delete user accounts to maintain system security and data integrity.</p>
                <a href="UserList.jsp" class="button">View Users</a>
            </div>

            <div class="dashboard-container">
                <h3>Review Donations</h3>
                <p>Access and review all incoming donations, track their status, and manage donor records.</p>
                <a href="adminDonationView.jsp" class="button">View Donations</a>
            </div>
